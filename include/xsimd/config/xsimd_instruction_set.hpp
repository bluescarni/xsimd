...
#define XSIMD_X86_AVX512F_VERSION XSIMD_VERSION_NUMBER(10, 0, 0)

#undef XSIMD_X86_INSTR_SET
#undef XSIMD_X86_INSTR_SET_AVAILABLE

#if !defined(XSIMD_X86_INSTR_SET) && defined(__AVX512F__)
    #define XSIMD_X86_INSTR_SET XSIMD_X86_AVX512F_VERSION
#endif
